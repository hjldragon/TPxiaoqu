...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">发布者:<?php echo ($list["sole_name"]); ?></div>
        <div class="noticeDetailInfo">发布时间：<?php echo (date('Y-m-d G:i:s',$list["create_time"])); ?></div>
        <div class="noticeDetailInfo">联系电话：<?php echo ($list["tel"]); ?></div>
        <h4 class="text-danger">价格:<?php echo ($list["price"]); echo $config['unit']?'万元':'月/元';?></h4>
