...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">活动截止时间：<?php echo (date('Y-m-d G:i:s',$list["deadline"])); ?></div>
        <div class="noticeDetailInfo pull-right"><a class="ajax-get confirm" href="<?php echo U('Activity/apply?id='.$list['id']);?>">申请参与活动</a></div>
