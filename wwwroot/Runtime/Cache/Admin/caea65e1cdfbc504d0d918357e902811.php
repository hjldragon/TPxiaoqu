...
<body>
    ...
    <div class="tab-wrap">
        <div class="tab-content">
            <!-- 表单 -->
            <form id="form" action="<?php echo U('add');?>" method="post" class="form-horizontal doc-modal-form">
                <!-- 基础 -->
                <div id="tab1" class="tab-pane in tab1">
                    <div class="form-item cf">
                        <label class="item-label">发布人<span class="check-tips">（请输入发布人）</span></label>
                        <div class="controls">
                            <input type="text" class="text " name="sole_name" value="">
                        </div>
                    </div>
                    <div class="form-item cf">
                    ...
                    <div class="form-item cf">
                        ...
                        <div class="controls">
                            <input type="text" class="text " name="price" value="">&nbsp;
                            单位：
                    ...
                    <div class="form-item cf">
                        ...
                        <div class="controls">
                            <input type="text" class="text time" name="clone_time" value=""></div>
                    </div>
